    ...
    <ImageBackground source={img} style={styles.container}>
        <View style={styles.backgroudcolour}>
            ...
            <View style={styles.flet}>
              ...
              <TextInput value={alamat} onChangeText={(alamat) => {setAlamat(alamat)}}  style={styles.sign}></TextInput>
              <Text style={{ marginTop: 20, marginLeft: 20 }}>No.Handphone :</Text>
              <TextInput value={handphone} onChangeText={(handphone) => {sethandphone(handphone)}} style={styles.sign1}></TextInput>
              <Text style={{ marginTop: 20, marginLeft: 20 }}>Nama Penerima :</Text>
              <TextInput value={nama} onChangeText={(nama) => {setNama(nama)}} style={styles.sign2}></TextInput>
              <Text style={{ marginTop: 20, marginLeft: 20 }}>Tanggal Pengantaran :</Text>
              <TextInput value={tanggal} onChangeText={(tanggal) => {setTanggal(tanggal)}} style={styles.sign3}></TextInput>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("imagepic")}>
                <View style={styles.kirim}>
                  <Text style = {{marginTop : 10, marginLeft : 28, letterSpacing: 0.5, fontWeight : "bold" }}>Next</Text>
                </View>
              </TouchableOpacity>
            </View>
        </View>
