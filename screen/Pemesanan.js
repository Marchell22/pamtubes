  ...
  return (
    <ImageBackground source={img} style={styles.container}>
      <View style={styles.backgroudcolour}>
        ...
        <Text style={{color: "#ffff", fontWeight: "bold", fontSize: 20, top: 60, left: 155}}>
          PILIHAN
        </Text>
        <TouchableOpacity onPress={() => navigation.navigate("Kiloan")}>
           <Text style={styles.button1}></Text>
           <Image style={{top: 5, left : 173,width : 50, height : 50}} source={require("../assets/weighing-machine.png")}></Image>
           <Text style={{top: 5, left : 173, fontSize: 16, fontWeight: "bold"}}>
              Kiloan
            </Text>
        </TouchableOpacity>      
        <TouchableOpacity onPress={() => navigation.navigate("Satuan")}>
           <Text style={styles.button1}></Text>
           <Image style={{top: 5, left : 173, width : 50, height : 50}} source={require("../assets/sport-wear.png")}></Image>
           <Text style={{top: 5, left : 173, fontSize: 16, fontWeight: "bold"}}>
              Satuan
            </Text>
        </TouchableOpacity>  
