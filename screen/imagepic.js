...
import { StyleSheet, Text, TouchableOpacity, Image, View, ImageBackground, TextInput, FlatList, ScrollView, SafeAreaView, Modal,Alert, Animated } from 'react-native';
    ...
    <ImageBackground source={img} style={styles.container}>
        <View style={styles.backgroudcolour}>
            <View style={styles.header}>
                ...
                <Text style={{ fontWeight: "bold", fontSize: 30, top: 50, left: 60, letterSpacing : 1 }}>Bukti</Text>
            ...
            <View style={styles.flet}>
             ...
             <TouchableOpacity  onPress={pickImage}>
                ...
                <Text style={{left : 100, top : 35, letterSpacing : 1, fontWeight : "bold"}}>Add Image</Text> 
            </TouchableOpacity>
            <View>{image && <Image source={{ uri: image.uri }} style={{ width: 250, height: 150, top : -50 }} />}</View>  
          </View>
              <TouchableOpacity onPress={uploadImage}>
                <View style={styles.kirim}>
                  <Text style = {{marginTop : 5, marginLeft : 28, letterSpacing: 0.5, fontWeight : "bold" }}>Kirim</Text>
                </View>
              </TouchableOpacity>
        </View>
